...
double T(double x1) throw (ErrorA5, double) {
    double term;
    string name;
...
double U(double x1) throw (ErrorA5, double) {
    double term;
    string name;
...
double Krn(double x, double y, double z) throw (double) {
...
double Srs11(double x, double y, double z) throw (double) {
    double term;
    if (z > y) {
...
double Krn1(double x, double y, double z) throw (double) {
...
double Srs2(double x, double y, double z) throw (double) {
    double term;
    if (z > y) {
        term = Srz(x, y, z) + y * x;
    }
...
double Krn2(double x, double y, double z) throw (double) {
...
double Srs3(double x, double y, double z) throw (double) {
    double term;
    if (z > y) {
        term = Srz(x, y, z) + y * x;
    }
...
double Qrz3(double x, double y) throw (double) {
    double term;
    if (y < 1 && y>-1) {
        term = x * Srs3(x, y, x);
    }
...
double Rrz3(double x, double y, double z) throw (double) {
    double term;
    if (x > y) {
        term = y * Qrz3(y, z);
    }
...
double Krn3(double x, double y, double z) throw (double) {
    double term;
    term = 83.1389 * Rrz2(x, y, z) + 4.8389 * Rrz2(x, z, y);

    return term;
}
double fun3(double x, double y, double z) throw (double) {
    double temp;
    temp = x * Krn3(x, y, z) + y * Krn3(x, z, y);
    return temp;
}

double fun4(double x, double y, double z) throw (double) {
    double temp;
