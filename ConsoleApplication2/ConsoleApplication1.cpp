...
double Srs1(double x, double y, double z) throw (ErrorDevideByZero, ErrorOpenFile, double) {
    double term;
    if (z > y) {
...
double Grs(double x, double y, double z) throw (ErrorDevideByZero, ErrorOpenFile, double) {
...
double Grs1(double x, double y, double z) throw (ErrorDevideByZero, ErrorOpenFile, double) {
...
double Srs2(double x, double y, double z) throw (ErrorDevideByZero, ErrorOpenFile, double) {
    double term;
    if (z > y) {
        term = Srz(x, y, z) + y * x;
    }
...
double Grs2(double x, double y, double z) throw (ErrorDevideByZero, ErrorOpenFile, double) {
