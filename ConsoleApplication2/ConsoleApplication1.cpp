...
double Gold(double x, double y) throw (ErrorA2, double) {
    double term = 0;
    if (x > y && y != 0) {
        term = x / y;
    }
        ...
        throw ErrorA2("DevideByZero");
    }

    return term;
}

double Glr(double x, double y) throw (ErrorA2, double) {
    double term = 0;
    if (x < 1 || (x * -1) < 1) {
        term = x;
    }
...
double Grs(double x, double y) throw (double) {
    double term = 0;
...
double Gold1(double x, double y) throw (double) {
    double term = 0;
    if (x > y && (y > 0.1 || -y < 0.1)) {
        term = x / y;
    }
    else if (y <= x && (x > 0.1 || -x < 0.1)) {
        term = y / x;
    }
    else if (x < y && (x > 0.1 || -x < 0.1)) {
        term = 0.15;
    }
    else if (y == 0) {
        term = 0.1;
...
double Glr1(double x, double y) throw (double) {
    double term = 0;
    if (x < 1 || (x * -1) < 1) {
        term = x;
    }
...
double Grs1(double x, double y) throw (double) {
    double term = 0;
